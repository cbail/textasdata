...
**[Strengths and Weaknesses of Text as Data](https://cbail.github.io/textasdata/strengths-weaknesses/rmarkdown/Strengths_and_Weaknesses.html)**  
...
All of the materials for this course are available online via the links above. Many of the datasets used are loaded directly from my Github page, which also hosts all of the source files necessary to produce the tutorials above. If you notice problems, or other limitations of the tutorials above, kindly submit a "pull" request (if you know how to use Github).
